...
/**
 *  Environment#registerStylusHelper(name, func) -> Void
 *  Environment#registerStylusHelper(helpers) -> Void
 *
 *  Proxy to [[Context.registerStylusHelper]] of current [[Environment#ContextClass]].
 *
 *
 *  ##### Example
 *
 *      env.registerStylusHelper('foo', function () {});
 *
 *      // shorthand syntax of
 *
 *      env.ContextClass.registerStylusHelper('foo', function () {});
 **/
Environment.prototype.registerStylusHelper = function () {
  this.ContextClass.registerStylusHelper.apply(null, arguments);
};
